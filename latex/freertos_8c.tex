...
\begin{DoxyCompactList}\small\item\em Function implementing the Traffic\+States thread. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{freertos_8c_a8784f1f2c238f1c5816419cb1012be02}{Userinputs}} (void \texorpdfstring{$\ast$}{*}argument)
\begin{DoxyCompactList}\small\item\em Function implementing the User\+Input thread. \end{DoxyCompactList}\item 
...
{\em File Name \+: \doxylink{freertos_8c}{freertos.\+c} Description \+: Code for freertos applications
...
This software is licensed under terms that can be found in the LICENSE file in the root directory of this software component. If no LICENSE file comes with this software, it is provided AS-\/\+IS. }\begin{DoxyCompactItemize}
\item 
...
Function implementing the Traffic\+States thread. 
...
\hline
\end{DoxyRetVals}
\Hypertarget{freertos_8c_a8784f1f2c238f1c5816419cb1012be02}\index{freertos.c@{freertos.c}!Userinputs@{Userinputs}}
...
Function implementing the User\+Input thread. 
...
\end{DoxyCode}
\Hypertarget{freertos_8c_a6a263905468b0c37de4ee5e50ede4e74}\index{freertos.c@{freertos.c}!defaultTaskHandle@{defaultTaskHandle}}
...
\Hypertarget{freertos_8c_aacd61ac1bbac156259774e474f6c501f}\index{freertos.c@{freertos.c}!greenDelay@{greenDelay}}
...
\Hypertarget{freertos_8c_a07ccd3c0f617bddd39d093910d3221ae}\index{freertos.c@{freertos.c}!is\_car\_ew\_waiting@{is\_car\_ew\_waiting}}
...
\Hypertarget{freertos_8c_ab7237d8693493b99cbd54eceaa5be728}\index{freertos.c@{freertos.c}!is\_car\_ns\_waiting@{is\_car\_ns\_waiting}}
...
\Hypertarget{freertos_8c_a4231e2f0f0de8aaea95db8b1ee010869}\index{freertos.c@{freertos.c}!is\_ped\_ns\_waiting@{is\_ped\_ns\_waiting}}
...
\Hypertarget{freertos_8c_acf2c8910e5ef71730f1b5eaaed6c496a}\index{freertos.c@{freertos.c}!msg\_failed@{msg\_failed}}
...
Success code\+: Returns if received command is valid \Hypertarget{freertos_8c_ae8af103831a49353d21ee13fa606a13f}\index{freertos.c@{freertos.c}!orangeDelay@{orangeDelay}}
...
\Hypertarget{freertos_8c_afdc417d2e606c678717ae6c984959f3c}\index{freertos.c@{freertos.c}!ped\_green@{ped\_green}}
...
\Hypertarget{freertos_8c_a6b59f75369700988fa3f2dfa5c225354}\index{freertos.c@{freertos.c}!pedestrianDelay@{pedestrianDelay}}
...
\Hypertarget{freertos_8c_a62170ad8bb4cb861ba9b2ff06d8a97c3}\index{freertos.c@{freertos.c}!redDelay@{redDelay}}
...
\Hypertarget{freertos_8c_aa42e6e3c5fb6a18cd287a0167a150602}\index{freertos.c@{freertos.c}!redDelayMax@{redDelayMax}}
...
\Hypertarget{freertos_8c_a832bfefba0c3f651c05cfc21aad39dd0}\index{freertos.c@{freertos.c}!rx\_data@{rx\_data}}
...
\end{DoxyCode}
\Hypertarget{freertos_8c_a86a239b9f60605dc32847d6e4afc389d}\index{freertos.c@{freertos.c}!SharedDataHandle@{SharedDataHandle}}
...
\Hypertarget{freertos_8c_a4fdd2968a38cf6b3344d0c9ce29f3b27}\index{freertos.c@{freertos.c}!toggleFreq@{toggleFreq}}
...
\Hypertarget{freertos_8c_a8bd115a2bb87df34db88d7249d7eeeb1}\index{freertos.c@{freertos.c}!TrafficStates\_attributes@{TrafficStates\_attributes}}
...
\end{DoxyCode}
\Hypertarget{freertos_8c_a97254cae64deebc5b0ba60f8f9a9c05f}\index{freertos.c@{freertos.c}!TrafficStatesHandle@{TrafficStatesHandle}}
...
\Hypertarget{freertos_8c_a9b2653317ef098565aa2c15e5669ec4b}\index{freertos.c@{freertos.c}!UartReady@{UartReady}}
...
\end{DoxyCode}
\Hypertarget{freertos_8c_a2e41409556accc6d8a0395f6ea0ff89e}\index{freertos.c@{freertos.c}!UserInputHandle@{UserInputHandle}}
...
\Hypertarget{freertos_8c_a30db9cbd5592bcc1e9c0132e03d22021}\index{freertos.c@{freertos.c}!walkingDelay@{walkingDelay}}
